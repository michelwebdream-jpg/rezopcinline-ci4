...
$sql = "UPDATE `REZO_FLASH_MISSION` SET `etat_mission`=1,`membres_lu_mission`='',`membres_refus_mission`='',`membres_fini_mission`='', `date_lancement`=NOW() WHERE code='$mon_code_perso' AND Id='$id_de_la_mission' ;";
