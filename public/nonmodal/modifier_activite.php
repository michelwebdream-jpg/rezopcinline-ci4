...
<div>
    ...
    <div class="formulaire_saisie_activite">
        ...
        <p>
            <label for="input_liens_kml">Tracés KML : <br>Entrez un ou plusieurs liens KML<br>les uns en dessous des autres.</label>
        <textarea name="liens_kml" id="input_liens_kml" value="" cols="50" rows="5" maxlength="256" style="display:inline-block;margin-left: 10px;width:100%"/>
        </p>       
    </div>
    <hr />
...
function enregistre_activite(){
    if ($('#input_nom_activite').val()==="")
	{
        ...
        var liens_kml=$('#input_liens_kml').val();
        
        liens_kml = liens_kml.replace(/(^[ \t]*\n)/gm, "");
        liens_kml = liens_kml.replace(/[&<>{}]/g, "-");
		...
		{
			enregistre_modification_activite_sur_serveur(Id_editing_activite_edition,nom_nouvelle_activite,nom_responsable_activite,adresse_activite,nature_activite,remarque_activite,listofcodeasauver,temp1.length-1,liens_kml);
		}else{
			sauve_nouvelle_activite_sur_serveur(nom_nouvelle_activite,nom_responsable_activite,adresse_activite,nature_activite,remarque_activite,listofcodeasauver,temp1.length-1,liens_kml);
		}
...
function sauve_nouvelle_activite_sur_serveur(nom_de_lactivite,nom_responsable_activite,adresse_activite,nature_activite,remarque_activite,listofcodeasauver,Qte,liens_kml){
...
function enregistre_modification_activite_sur_serveur(Id, nom_de_lactivite,nom_responsable_activite,adresse_activite,nature_activite,remarque_activite,listofcodeasauver,Qte,liens_kml){
...
function ajoute_utilisateur_table_contact_PC(codeapasser){
  ...
  ;
    ...
    if (data_pass!==""){
        ...
        $('#input_liens_kml').val(data_pass.liens_kml);
